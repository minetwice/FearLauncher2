...
import com.fearlauncher.ui.theme.BlackSurface
import com.fearlauncher.ui.theme.SilverDark
import com.fearlauncher.ui.theme.SilverPrimary
    ...
    Card(
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .size(48.dp)
                    .background(SilverDark, RoundedCornerShape(8.dp))
            )
